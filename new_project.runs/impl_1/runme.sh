...
HD_PWD='C:/Users/DELL/Desktop/new_project/new_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_processor.tcl -notrace
