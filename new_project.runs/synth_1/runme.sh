...
HD_PWD='C:/Users/DELL/Desktop/new_project/new_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_processor.tcl
